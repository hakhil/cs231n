...
class TwoLayerNet(object):
  ...
  def train(self, X, y, X_val, y_val,
            ...
            batch_size=200, verbose=False ,dropout_fraction = 0, mu = 0.9, momentum=False):
    """
    ...
    for it in range(num_iters):
      ...
      for variable in self.params:
          if momentum:
              self.paramsV[variable] = self.paramsV[variable] * mu - learning_rate * grads[variable]
              self.params[variable] += self.paramsV[variable]
          else:
